...
class RecordCollection:
    ...
    def read_sweep_realtime(self):
        process = Popen(['hackrf_sweep', '-f 980:1560','-w 1000000', '-a 1'], stdout=PIPE)
        ...
        while process.poll() is None:
            ...
            line_count += 1
            if len(line) < 6:
                raise ValueError("items in read line is small")
    ...
    def get_power_spectr(self, index):
        """Получить энергитический спектр развертки по индексу"""
