...
e - 1.48
f - 1.52
hackrf_sweep -f 950:1560 > test.csv
"""
...
if __name__ == "__main__":
    ...
    plt.hist(Y_power, len(sweep.spectr), range=(sweep.f_min, sweep.f_max))
    ...
    plt.yticks(Y_td[0::100], [Sweep.get_str_dt(item, "%H:%M:%S") for item in ts_list][0::100])
    plt.show()
